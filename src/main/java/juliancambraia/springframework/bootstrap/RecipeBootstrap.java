package juliancambraia.springframework.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitOfMeasure pintUom = dashSpoonUomOptional.get();
        ...
        guacRecipe.setDifficultyEnum(DifficultyEnum.EASY);
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), dashUom, guacRecipe));
        ...
        tacosRecipe.setDifficultyEnum(DifficultyEnum.MODERATE);
        ...
        tacosRecipe.getIngredients().add(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(".5"), eachUom, tacosRecipe));
